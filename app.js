...
$climate.onclick = () =>{
    ...
    $consumption.onclick = () =>{
        ...
        $resources.onclick = () =>{
            ...
            document.getElementById("cause").innerHTML = "Do your bit! Avoid all things plastic. Belive in Reduce, Reuse and Recycle.";
            }
            ...
            $people.onclick = () =>{
                ...
                document.getElementById("cause").innerHTML = "Do your bit! Never waste  food.Rather offer it to people or animals who are in need.";
                }
